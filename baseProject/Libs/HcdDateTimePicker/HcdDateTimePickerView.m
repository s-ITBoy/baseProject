        ...
        if (btns.tag == kOKBtnTag) {
            ...
            switch (self.datePickerMode) {
                ...
                case DatePickerDateTimeMode:
                    self->dateTimeStr = [NSString stringWithFormat:@"%ld-%02ld-%02ld %02ld:%02ld:%02ld",(long)self.curYear,(long)self.curMonth,(long)self.curDay,(long)self.curHour,(long)self.curMin,(long)self.curSecond];
                    break;
                case DatePickerMonthDayMode:
                    self->dateTimeStr = [NSString stringWithFormat:@"%02ld-%02ld",(long)self.curMonth,(long)self.curDay];
                    break;
                case DatePickerYearMonthMode:
                    self->dateTimeStr = [NSString stringWithFormat:@"%ld-%02ld",(long)self.curYear,(long)self.curMonth];
                    break;
            ...
            if (weak.clickedOkBtn) {
                weak.clickedOkBtn(self->dateTimeStr);
            }
